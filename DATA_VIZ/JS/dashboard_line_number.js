...
d3.csv("../DATA_VIZ/TEST_CSV/df_1_4.csv", function (d) {
...
.then(function (data) {
    var width = 540;
    var height = 400;
    var margin = ({ top: 0, right: 00, bottom: 50, left: 20 });
    ...
    const svg = d3.select("div.line_number")
        .append("svg")
        .attr("width", width)
        .attr("height", height);
    ...
    var y = d3.scaleLinear()
        .domain([0, d3.max(data, d => d.projects) * 1.1])
